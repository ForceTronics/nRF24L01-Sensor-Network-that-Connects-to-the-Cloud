...
#ifndef __RF24NETWORKNOSLEEP_H__
#define __RF24NETWORKNOSLEEP_H__
...
public:
  ...
  RF24NetworkNoSleep( RF24& _radio );
  ...
  RF24NetworkNoSleep( RF24& _radio, RF24& _radio1);
 ...
 void setup_watchdog(uint8_t prescalar);
   ...
   */
 //bool sleepNode( unsigned int cycles, int interruptPin ); //Don't need for AVR only
